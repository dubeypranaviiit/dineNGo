...
//   // Track **local quantity for this specific dish**
//   const [quantity, setQuantity] = useState(0);

//   // Sync local quantity with cart store
//   useEffect(() => {
...
//   const handleRemove = () => {
//     if (quantity <= 1) removeFromCart(_id);
//     else {
//       removeFromCart(_id);
//       addToCart({ _id, name, price, image, quantity: quantity - 1 });
//     }
//   };
